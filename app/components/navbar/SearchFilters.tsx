...
const SearchFilters = () => {
    ...
    return (
        ...
        >
            <div className="hidden lg:block">
                <div className="flex flex-row items-center justify-between">
                    <div className="cursor-pointer w-[250px] h-[48px] lg:h-[64] px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
                        <p className="text-xs font-semibold mt-3">Get your Product</p>
                        
                    </div>

                    <div className="cursor-pointer h-[48px] lg:h-[64] px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
                        <p className="text-xs font-semibold mt-3">Search for it</p>
            ...
            <div className="p-2">
                <div className="cursor-pointer p-2 lg:p-4 bg-[#c7a4aa] hover:bg-[#b3914aec] transition rounded-full text-white">
                    <svg 
                        viewBox="0 0 32 32" 
